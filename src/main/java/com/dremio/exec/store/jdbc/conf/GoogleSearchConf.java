...
@SourceType(value = "GoogleSearchARP", label = "GoogleSearch",uiConfig = "googlesearch-layout.json")
public class GoogleSearchConf extends AbstractArpConf<GoogleSearchConf> {
  private static final String ARP_FILENAME = "arp/implementation/googlesearch-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googlesearch.GoogleSearchDriver";
